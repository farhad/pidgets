...
public class ParsiRadioButton extends AppCompatRadioButton {
  ...
  public ParsiRadioButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    TypedArray typedArray = context
        .obtainStyledAttributes(attrs, R.styleable.ParsiRadioButton, defStyleAttr, defStyleAttr);
  ...
  private void initialize(Context context, TypedArray typedArray) {
    if (!isInEditMode()) {
      ...
      useParsiDigits = typedArray.getBoolean(R.styleable.ParsiRadioButton_useParsiDigits, false);
      typefaceStyle = FontType
          .getType(typedArray.getInt(R.styleable.ParsiRadioButton_typefaceStyle, 0));
